    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500">Automatically approve new user registrations</p>
            </div>
            <button 
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500">Users must verify their email before activation</p>
            </div>
            <button 
            ...
            >
              <span 
                :class="emailVerification ? 'translate-x-6' : 'translate-x-1'"
                class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform"
              />
            </button>
          </div>
          ...
          <!-- Required fields -->
          <div>
            <label class="block text-sm font-semibold text-gray-900 mb-3">Required fields</label>
            <div class="space-y-2">
              <label class="flex items-center">
                <input v-model="requiredFields.prefix" type="checkbox" class="rounded border-gray-300 text-purple-600 focus:ring-purple-500">
                <span class="ml-2 text-sm text-gray-700">Prefix (Mr., Ms., Dr.)</span>
              </label>
              <label class="flex items-center">
                <input v-model="requiredFields.firstName" type="checkbox" class="rounded border-gray-300 text-purple-600 focus:ring-purple-500" checked disabled>
                <span class="ml-2 text-sm text-gray-700">First Name (Required)</span>
              </label>
              <label class="flex items-center">
                <input v-model="requiredFields.lastName" type="checkbox" class="rounded border-gray-300 text-purple-600 focus:ring-purple-500" checked disabled>
                <span class="ml-2 text-sm text-gray-700">Last Name (Required)</span>
              </label>
              <label class="flex items-center">
                <input v-model="requiredFields.mobile" type="checkbox" class="rounded border-gray-300 text-purple-600 focus:ring-purple-500">
                <span class="ml-2 text-sm text-gray-700">Mobile Number</span>
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500">Receive email alerts for new registrations</p>
            </div>
            <button 
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500">Send alerts to Slack channel</p>
            </div>
            <button 
            ...
            >
              <span 
                :class="slackNotifications ? 'translate-x-6' : 'translate-x-1'"
                class="inline-block h-4 w-4 transform rounded-full bg-white transition-transforms"
              />
            </button>
          </div>
        </div>
      ...
      <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
        <div class="flex items-center mb-6">
          ...
          <h3 class="text-xl font-bold text-gray-900">Analytics & Tracking</h3>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500">Track registration funnel and conversions</p>
            </div>
            <button 
            ...
            >
              <span 
                :class="googleAnalytics ? 'translate-x-6' : 'translate-x-1'"
                class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform"
              />
            </button>
          </div>
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500">Enable CSV/Excel export of registration data</p>
            </div>
            <button 
            ...
            >
              <span 
                :class="dataExport ? 'translate-x-6' : 'translate-x-1'"
                class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform"
              />
            </button>
          </div>
      ...
      <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
        <div class="flex items-center mb-6">
          ...
          <h3 class="text-xl font-bold text-gray-900">Security & Privacy</h3>
        </div>
        ...
        <div class="space-y-6">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500">Prevent spam registrations with CAPTCHA</p>
            </div>
            <button 
              @click="toggleCaptcha"
            ...
            >
              <span 
                :class="captcha ? 'translate-x-6' : 'translate-x-1'"
                class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform"
              />
            </button>
          </div>
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500">Automatically block IPs with suspicious activity</p>
            </div>
            <button 
            ...
            >
              <span 
                :class="ipBlocking ? 'translate-x-6' : 'translate-x-1'"
                class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform"
              />
            </button>
          </div>
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500">Encrypt sensitive registration data at rest</p>
            </div>
            <button 
            ...
            >
              <span 
                :class="dataEncryption ? 'translate-x-6' : 'translate-x-1'"
                class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform"
              />
            </button>
          </div>
